...
echo -e "cp ${tmp_dir}/*.md ${local_project_location}/docs/" >> ${local_project_location}/run.sh
echo -e "mv ${local_project_location}/docs/info.md ${local_project_location}/docs/index.md" >> ${local_project_location}/run.sh
echo -e "rm ${local_project_location}/docs/main.knit.md" >> ${local_project_location}/run.sh
